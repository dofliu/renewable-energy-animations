...
usage: python build.py EPISODE.js --out OUT.html [--theme journal|classic]
...
--theme NAME adds the brand layer assets/engine/theme-NAME.js / .css / .head.html. Default: journal (DOF LAB house style); --theme classic = original look without a theme layer.
"""
...
ap=argparse.ArgumentParser();ap.add_argument('episode');ap.add_argument('--out',required=True);ap.add_argument('--theme',default='journal');a=ap.parse_args()
